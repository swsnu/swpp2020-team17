...
AUTH_URL_DISCORD = 'https://discord.com/api/oauth2/authorize?client_id=773940751608053771&redi' \
                   'rect_uri=http%3A%2F%2F54.236.84.205%3A8000%2Fapi%2Flogin%2' \
                   'Fredirect&response_type=code&scope=identify'
...
def discord_login_redirect(request):
    ...
    return redirect("http://54.236.84.205/")
...
def exchange_code(code: str):
    ...
    data = {
        ...
        "code": code,
        "redirect_uri": "http://54.236.84.205:8000/api/login/redirect",
        "scope": "identify",
...
def discord_logout(request):
    ...
    print(user.login)
    logout(request)
    return redirect('http://54.236.84.205:3000/login/')
